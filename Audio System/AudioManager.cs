...
public partial class AudioManager : Node
{
    ...
    [Export] private float unloadDelay = 60f;  // The lifespan of a pooled audio before getting dropped from memory
    [Export] private int maxCachedSounds = 30;  // Max Audio pooling amount
    [Export] private float loadedAudioCleanupTimer = 5f;  // Pooling unloading checking cooldown

    [Export] private int preloadedPlayersNodesCount = 10;  // Number of available AudioStreamPlayer Nodes created on launch
    [Export] private int preloadedPlayers3DNodesCount = 20;  // Number of available AudioStreamPlayer3D Nodes created on launch

    private Node3D audioHolderNode;
    ...
    public override void _Ready()
    {
        ...
        Node3D _audioHolderNode = new Node3D();
        _audioHolderNode.Name = "Audio Players Holder";
        this.AddChild(_audioHolderNode);
        audioHolderNode = _audioHolderNode;
    ...
    /// <param name="volumeDb"></param>
    /// <param name="fadeDuration"></param>
    public void SetBusVolumeMultiplier(AudioCategory category, float targetMultiplier, float fadeDuration = 0f)
    {
